...
public interface OrderRepository extends BaseRepository<Order, String> {
    ...
    @Query(nativeQuery = true, value = "select o.orderNumber,c.name as client,pay_direction as payDirection,o.time,o.status,o.price,o.remarks from orders o,client c where o.status in ?1 and o.orderNumber like ?2 and o.`client`=c.`id` order by ordernumber desc")
