...
# Database: demo
# Generation Time: 2019-10-08 09:20:06 +0000
# ************************************************************
...
VALUES
	...
	(13,'DDBH20191008001',13,'黑色','L',100,5.000,500.000),
	(14,'DDBH20191008001',12,'白色','XL',66,3.000,198.000),
	...
	(22,'DDBH20191008002',12,'白色','XL',1111,3.000,3333.000);
...
INSERT INTO `orders` (`orderNumber`, `client`, `pay_direction`, `remarks`, `time`, `timestamp`, `status`, `status_people`, `founder`, `price`)
VALUES
	('DDBH20190912001',18,'P','','2019-10-08 02:42:34','2019-09-12 04:19:56','Z','lisi',NULL,300.678),
	('DDBH20191008001',18,'R','','2019-10-08 02:37:08','2019-10-08 01:13:52','Z',NULL,NULL,698.000),
	('DDBH20191008002',17,'R','131231111111111','2019-10-08 03:49:55',NULL,'Z',NULL,'lisi',3333.000),
	('DDBH20191008003',19,'P','','2019-10-08 03:07:35','2019-10-08 03:07:35','Z',NULL,'lisi',1332.000),
	('DDBH20191008004',18,'R','','2019-10-08 03:22:59','2019-10-08 03:22:59','Z',NULL,'lisi',3996.000);
...
VALUES
	...
	('lisi','老员工','$2a$10$oA7pvJKBxWUu6CiolxpXoeX0kaHZmEzFZrToPnSv2MS.cpWe4Phxq','root','lisi@163.com','2019-10-08 16:47:04','12345678902','zhangsan',NULL,'Y',NULL),
	('new','新人','$2a$10$G782c/VA7apYcfWuBMEYwuZDVJHaQuc/RDwOuWJTR1cqI2gbUub6K','role','1@1.com','2019-08-13 15:13:35','11111111111','admin','2019-08-13 01:46:23','Y',NULL);
